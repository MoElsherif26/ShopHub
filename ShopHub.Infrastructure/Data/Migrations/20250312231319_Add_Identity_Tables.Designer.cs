...
namespace ShopHub.Infrastructure.Data.Migrations
{
    ...
    [Migration("20250312231319_Add_Identity_Tables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShopHub.Core.Entities.Address", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ShopHub.Core.Entities.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ShopHub.Core.Entities.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ShopHub.Core.Entities.Address", b =>
                {
                    b.HasOne("ShopHub.Core.Entities.AppUser", "AppUser")
                        .WithOne("Address")
                        .HasForeignKey("ShopHub.Core.Entities.Address", "AppUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
